...
def send_commands():
    if os.path.isfile("./show_images"):
        ...
        os.system("rm ~/show_videos ~/show_countdown")  # make sure countdown is removed
    elif os.path.isfile("./show_videos"):
        os.system("touch ~/show_videos")
        os.system("rm ~/show_images ~/show_countdown")
    else:
        # Trigger countdown mode
        os.system("touch ~/show_countdown")
        os.system("rm ~/show_images ~/show_videos")
